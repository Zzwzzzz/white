...
/obj/machinery/vending/dude
	...
	name = "Великая жатва"
	desc = "Только ты можешь остановить зло, прячущееся в людях."
	slogan_delay = 25000
	max_integrity = 750
	icon_state = "dude"
	product_slogans = "Земля голодна, её сердце сокращается и жаждет очищения, земля хочет пить.;Будь благословлён, покорный, ибо их тела - удобная мишень.;В воздухе запах смерти и разложения - запах победы.;Жизнь дорога, смерть бесплатная. Поторопись, предложение ограничено.;Я надену обезабраженные органы моих врагов словно шляпу и завяжу их словно галстук. О как хорош будет мой танец.;Людские отбросы сочатся чрез сжимющиеся пальцы смерти.;Кровь брызжет повсюду словно река, протекающая вокруг меня и утаскивающая своим течением.;Запах тёмной кожи проникает в мои ноздри вместе с запахом смерти. Человеческие останки застряли в моей одежде словно драгоценности, и я всё ещё хожу по костям, по колено в крови и потрохах.;Насладись замёрзшими экскрементами машин смерти, неумолимо перемалывающих плоть...;Кто сказал, что они пали и не могут быть возвращены на правильный путь?"
	product_ads = "Земля голодна, её сердце сокращается и жаждет очищения, земля хочет пить.;Будь благословлён, покорный, ибо их тела - удобная мишень.;В воздухе запах смерти и разложения - запах победы.;Жизнь дорога, смерть бесплатная. Поторопись, предложение ограничено.;Я надену обезабраженные органы моих врагов словно шляпу и завяжу их словно галстук. О как хорош будет мой танец.;Людские отбросы сочатся чрез сжимющиеся пальцы смерти.;Кровь брызжет повсюду словно река, протекающая вокруг меня и утаскивающая своим течением.;Запах тёмной кожи проникает в мои ноздри вместе с запахом смерти. Человеческие останки застряли в моей одежде словно драгоценности, и я всё ещё хожу по костям, по колено в крови и потрохах.;Насладись замёрзшими экскрементами машин смерти, неумолимо перемалывающих плоть...;Кто сказал, что они пали и не могут быть возвращены на правильный путь?"
	vend_reply = "Только моё оружие понимает меня."
